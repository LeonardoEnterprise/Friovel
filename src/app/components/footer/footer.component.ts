...
export class FooterComponent {
  ...
  openLicenseModal() {
    const licenseContent = `
      <p>Este site é propriedade da Friovel e é fornecido pela LPA TECH. Ao acessar este site, você concorda em cumprir os termos e condições a seguir:</p>
      1. Você está autorizado a visualizar e baixar o conteúdo deste site apenas para uso pessoal e não comercial.</p>
      2. Você não tem permissão para reproduzir, distribuir, modificar ou de outra forma usar qualquer conteúdo deste site para fins comerciais sem a permissão expressa por escrito da Friovel.</p>
      3. A Friovel se reserva o direito de modificar ou encerrar o acesso a este site a qualquer momento, sem aviso prévio.</p>
      4. Todas as marcas registradas, logotipos e conteúdo deste site são propriedade exclusiva da Friovel e não podem ser usados sem autorização.</p>
      5. Este site pode conter links para sites de terceiros. A Friovel não é responsável pelo conteúdo ou pelas práticas de privacidade desses sites.</p>
  ...
  openTermsModal() {
    ...
    <p>Bem-vindo ao site da Friovel, desenvolvido pela LPA TECH. Ao acessar e usar este site, você concorda em cumprir os seguintes termos e condições:</p>
    ...
    <ol>
      ...
      <li><strong>Conteúdo:</strong> O conteúdo deste site é de propriedade da Friovel e está protegido por direitos autorais. Qualquer uso não autorizado do conteúdo é estritamente proibido.</li>
      <li><strong>Links para Terceiros:</strong> Este site pode conter links para sites de terceiros. A Friovel não é responsável pelo conteúdo ou pelas práticas de privacidade desses sites.</li>
      <li><strong>Privacidade:</strong> A Friovel respeita a sua privacidade. Consulte nossa Política de Privacidade para obter informações sobre como coletamos e usamos seus dados pessoais.</li>
      <li><strong>Alterações nos Termos:</strong> A Friovel se reserva o direito de modificar estes termos a qualquer momento, sem aviso prévio. Recomendamos que você revise regularmente os termos de uso deste site.</li>
    </ol>
  ...
  openPrivacyModal() {
    ...
    <p>A Friovel valoriza a sua privacidade e está comprometida em proteger seus dados pessoais. Esta Política de Privacidade descreve como coletamos, usamos e protegemos suas informações quando você acessa nosso site, desenvolvido pela LPA TECH.</p>
